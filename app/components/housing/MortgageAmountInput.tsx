...
export function MortgageAmountInput({ onNext, onBack, initialValue }: MortgageAmountInputProps) {
  ...
  return (
    <div className="flex-1 flex flex-col animate-fadeIn">
      <div className="mb-8">
        ...
        <p className="text-[15px] text-gray-500 leading-relaxed">주택담보대출 잔액</p>
      </div>
